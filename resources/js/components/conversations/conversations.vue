    ...
    <section class="conversation">
        <div class="conversation_block">
            <div class="conversation_exit">
                <span>{{ __("conversations", "Close") }}</span>
                <svg class="conversation_cross" xmlns="http://www.w3.org/2000/svg" width="14.483" height="14.483" viewBox="0 0 14.483 14.483">
            ...
            <img class="conversation_img" src="/img/illustration/viber.svg" alt="SWIFT Viber">
            ...
            <div class="conversation_button button mod-blue">{{ __("conversations", "Write in Viber") }}</div>
            ...
            <div class="conversation_created-by">{{ __("conversations", "Creat de SwiftCallBack") }}</div>
