<template>
    <section class="auth">
        <div class="auth_wrapper">
            <logo class="regHeader" size="auth"></logo>
            <div class="auth_method">
                <span class="mod_passive" @click="gotoAuth()">{{ __("authentication", "Login") }}</span>
                /
                <span @click="gotoReg()">{{ __("authentication", "Registration") }}</span>
            </div>
